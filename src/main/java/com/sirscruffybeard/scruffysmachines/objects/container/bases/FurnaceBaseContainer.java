package com.sirscruffybeard.scruffysmachines.objects.container.bases;

import java.util.Objects;

import com.sirscruffybeard.scruffysmachines.init.BlockInit;
import com.sirscruffybeard.scruffysmachines.objects.container.ModFurnaceFuelSlot;
...
public abstract class FurnaceBaseContainer extends RecipeBookContainer<IInventory>{
	...
	private FurnaceBaseTileEntity tileEntity ;

	public FurnaceBaseContainer(ContainerType<?> containerTypeIn, IRecipeType<? extends AbstractCookingRecipe> recipeTypeIn, int id, PlayerInventory playerInventoryIn, FurnaceBaseTileEntity tileEntity) {
		this(containerTypeIn, recipeTypeIn, id, playerInventoryIn, new Inventory(3), new IntArray(4), tileEntity);

	}

	protected FurnaceBaseContainer(ContainerType<?> containerTypeIn, IRecipeType<? extends AbstractCookingRecipe> recipeTypeIn, int id, PlayerInventory playerInventoryIn, IInventory furnaceInventoryIn, IIntArray furnaceDataIn, FurnaceBaseTileEntity tileEntityIn) {
		...
		this.addSlot(new ModFurnaceFuelSlot(this, furnaceInventoryIn, 1, 56, 53));
	 ...
	 * GetTileEntity
	 ********************************************************************************************************************************/
	protected static FurnaceBaseTileEntity getTileEntity(final PlayerInventory playerInventory, final PacketBuffer data) {
		...
		if(tileAtPos instanceof FurnaceBaseTileEntity ) {
			
			return(FurnaceBaseTileEntity)tileAtPos;
		}
	...
	public void func_217056_a(boolean p_217056_1_, IRecipe<?> recipe, ServerPlayerEntity serverPlayer) {
		(new ServerRecipePlacerFurnace<>(this)).place(serverPlayer, (IRecipe<IInventory>)recipe, p_217056_1_);
	}
	...
	public boolean isFuel(ItemStack itemStack) {
		return FurnaceBaseTileEntity.isFuel(itemStack);
	}
