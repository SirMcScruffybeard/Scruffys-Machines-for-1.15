package com.sirscruffybeard.scruffysmachines.gui.bases;
...
public abstract class FurnaceBaseScreen <T extends FurnaceBaseContainer> extends ContainerScreen<T> implements IRecipeShownListener  {
	...
	public FurnaceBaseScreen(T screenContainer, AbstractRecipeBookGui recipeGuiIn, PlayerInventory inv, ITextComponent titleIn, ResourceLocation guiTextureIn) {
	...
	protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) {
		...
		if (((FurnaceBaseContainer)this.container).func_217061_l()) {
			int k = ((FurnaceBaseContainer)this.container).getBurnLeftScaled();
			this.blit(i + 56, j + 36 + 12 - k, 176, 12 - k, 14, k + 1);
		}

		int l = ((FurnaceBaseContainer)this.container).getCookProgressionScaled();
