...
public class BrickFurnaceContainer extends RecipeBookContainer<IInventory> {
	...
	public BrickFurnaceContainer(final int windowId, final PlayerInventory playerInventoryIn, final BrickFurnaceTileEntity tileEntityIn) {
		...
		int inX = 47;
		int inY = 19;
		this.addSlot(new Slot(tileEntityIn, BrickFurnaceTileEntity.MATERIAL, inX, inY));

		int fuelX = 47;
		int fuelY = 67;
		this.addSlot(new ModFurnaceFuelSlot(this, tileEntityIn, BrickFurnaceTileEntity.FUEL, fuelX, fuelY));

		int outX = 134;
		int outY = 39;
		this.addSlot(new ModFurnaceResultSlot(playerInventoryIn.player, tileEntityIn, BrickFurnaceTileEntity.OUTPUT, outX, outY));
