...
public class LeatherChestTileEntity extends LockableLootTileEntity {
	...
	public static final String ID = LeatherChestBlock.ID;
	...
	@Override
	public NonNullList<ItemStack> getItems() { return this.chestContents; }
	...
	protected ITextComponent getDefaultName() {
		...
		return new TranslationTextComponent("container." + LeatherChestBlock.ID);
	}
